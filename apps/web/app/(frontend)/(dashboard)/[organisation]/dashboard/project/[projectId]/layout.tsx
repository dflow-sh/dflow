...
import {
  ...
  getProjectDetails,
} from '@dflow/actions/pages/project'
...
import CreateTemplateFromProject from '@dflow/components/project/CreateTemplateFromProject'
import ProjectOptionsDropdown from '@dflow/components/project/ProjectOptionsDropdown'
import CreateService from '@dflow/components/service/CreateService'
import ServiceList from '@dflow/components/service/ServiceList'
import ServicesArchitecture from '@dflow/components/service/ServicesArchitecture'
import DeployTemplate from '@dflow/components/templates/DeployTemplate'
import { Alert, AlertDescription, AlertTitle } from '@dflow/components/ui/alert'
import { Project, Server, Service } from '@/payload-types'
import { ArchitectureContextProvider } from '@dflow/providers/ArchitectureProvider'
