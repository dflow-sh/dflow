...
export const themeFields: Field[] = [
    ...
    fields: [
      {
        ...
        fields: [
          // background
          {
            ...
            admin: {
              components: {
                Field: '@dflow/core/payload/fields/theme/ColorField',
              },
            },
            required: true,
          ...
          // chart-1
          {
            ...
            name: 'chart1',
            admin: {
              components: { Field: '@dflow/core/payload/fields/theme/ColorField' },
            },
            required: true,
  ...
  // Fonts
  {
    ...
    admin: {
      components: {
        beforeInput: ['@dflow/core/payload/fields/theme/FontFieldDescription'],
      },
    },
    fields: [
      {
  ...
  // Radius
  {
    admin: {
      components: {
        Field: '@dflow/core/payload/fields/theme/RadiusField',
      },
    },
    type: 'select',
    name: 'radius',
