...
import { Card, CardContent, CardFooter, CardHeader } from '@dflow/core/components/ui/card'
  ...
  return (
    <div className='mx-auto flex min-h-screen w-full flex-col items-center justify-center gap-4 px-5'>
      ...
      <Card className='mb-20 w-full max-w-4xl'>
        <CardHeader>
          <div className='text-foreground flex items-center justify-between gap-2 text-sm font-extralight tracking-wide'>
            <div>
