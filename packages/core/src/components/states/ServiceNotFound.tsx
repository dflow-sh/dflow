...
const ServiceNotFound = ({
  message = "The service you're looking for doesn't exist or may have been deleted.",
      ...
      <div className='grid min-h-[40vh] place-items-center'>
        <div className='max-w-md space-y-4 text-center'>
          ...
          <p className='text-muted-foreground'>
            The service you&apos;re looking for doesn&apos;t exist or may have
            been deleted. Please check the URL or return to your services list.
          </p>
          <Button
