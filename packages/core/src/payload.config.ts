...
import { autoLogin } from '@dflow/core/payload/endpoints/auto-login'
import { logs } from '@dflow/core/payload/endpoints/logs'
import { serverEvents } from '@dflow/core/payload/endpoints/server-events'
  ...
  admin: {
    ...
    importMap: {
      ...
      importMapFile: path.resolve(
        dirname,
        '../../../apps/web/src/app/(payload)/payload-admin/importMap.js',
      ),
    },
  },
