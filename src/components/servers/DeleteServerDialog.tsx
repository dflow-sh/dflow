                  ...
                  <div className='space-y-3 rounded-md border p-3'>
                    ...
                    <div className='flex items-start space-x-3'>
                      ...
                      <div className='space-y-1'>
                        ...
                        <p className='text-xs text-muted-foreground'>
                          Permanently remove all database backups associated
                          with services on this server
                        </p>
                      </div>
                    </div>
                  </div>
                      ...
                      <div className='space-y-2'>
                        ...
                        {deleteBackups && (
                          <div>
                            ...
                            All database backups associated with services on
                            this server will be permanently deleted. This may
                            affect your ability to restore services in the
                            future.
                          </div>
                        )}
                      </div>
