...
export default function ToggleTheme() {
  ...
  return (
    <Toggle
      variant='outline'
      className={
        'group hidden size-9 data-[state=on]:bg-transparent data-[state=on]:hover:bg-muted md:block'
      }
      pressed={theme === 'dark'}
      onPressedChange={() =>
      ...
      {/* Use Tailwind's dark: and data-[state=on]: to control icon visibility */}
      <MoonIcon
        size={16}
