  ...
  'inline-flex items-center rounded-md border px-2.5 py-0.5 text-xs font-semibold transition-colors focus:outline-hidden focus:ring-2 focus:ring-ring focus:ring-offset-2',
  {
    variants: {
      variant: {
        ...
        destructive:
          'border-transparent bg-destructive/30 text-destructive shadow-sm hover:bg-destructive/20',
        outline: 'text-primary border-primary',
        info: 'border-transparent bg-info-foreground text-info hover:bg-info-foreground/80',
        warning:
